            ...
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<c:url value='/contracts/myContract' />">See my contracts</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<c:url value='/features/blockingFeatures/seeAll' />">See blocked options</a>
                            </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<c:url value='/features/dismissRequiredFeatures' />">Dismiss required
                                options</a></li>
                            <li><a href="<c:url value='/features/requiredFeatures/seeAll' />">See required options</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="dropdown float-right">
                    <button class="btn btn-primary dropdown-toggle pull-right logout-button" type="button"
                            data-toggle="dropdown">${loggedinuser}
